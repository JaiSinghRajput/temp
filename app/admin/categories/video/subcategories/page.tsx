...
export default function SubcategoriesPage() {
  ...
  const init = async () => {
    const json = await VideocategoryService.getVideoCategories();
  ...
  const fetchSubcategories = async (categoryId: number) => {
    const json = await VideocategoryService.getVideoSubcategories(categoryId);
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    const json = await VideocategoryService.createVideoSubcategory({
  ...
  const handleDelete = async (id: number) => {
    ...
    const json = await VideocategoryService.deleteVideoSubcategory(id);
