...
import { GiftcategoryService } from '@/services';
...
export default function SubcategoriesPage() {
  ...
  const init = async () => {
    const json = await GiftcategoryService.getGiftCategories();
  ...
  const fetchSubcategories = async (categoryId: number) => {
    const json = await GiftcategoryService.getGiftSubcategories(categoryId);
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    const json = await GiftcategoryService.createGiftSubcategory({
  ...
  const handleDelete = async (id: number) => {
    ...
    const json = await GiftcategoryService.deleteGiftSubcategory(id);
