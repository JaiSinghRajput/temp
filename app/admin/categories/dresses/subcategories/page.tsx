...
export default function SubcategoriesPage() {
  ...
  const init = async () => {
    const json = await DresscategoryService.getDressCategories();
  ...
  const fetchSubcategories = async (categoryId: number) => {
    const json = await DresscategoryService.getDressSubcategories(categoryId);
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    const json = await DresscategoryService.createDressSubcategory({
  ...
  const handleDelete = async (id: number) => {
    ...
    const json = await DresscategoryService.deleteDressSubcategory(id);
