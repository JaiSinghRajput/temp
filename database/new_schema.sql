...
-- DATABASE
-- =====================================================
CREATE DATABASE IF NOT EXISTS dwh_shop_database DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE products (
    ...
    CONSTRAINT products_ibfk_1 FOREIGN KEY (content_id) REFERENCES content_items (id) ON DELETE SET NULL
